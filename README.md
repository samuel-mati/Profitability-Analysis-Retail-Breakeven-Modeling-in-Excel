...
## Executive Summary
This project provides a **Prescriptive Financial Analysis** framework for a small retail business owner (Mr. Tom Miller) struggling with intermittent losses (**Net Margin Erosion**).

The Solution: Using **Goal Seek** modeling in Excel, the analysis diagnoses the root cause of the loss in the worst-performing month and provides a quantifiable, immediate mandate for corrective action.
